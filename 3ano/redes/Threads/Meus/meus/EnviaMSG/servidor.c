...
int matriz_cliente[20]; /*Para salvar os descritores de sockets dos clientes*/
int total = 0;/*Faz a contagem do total de clientes*/
...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    {
	adiciona_cliente(novo_socket);/*Adicionando clientes no vetor de descritores*/
...
void* thread_proc(void *arg)
{
    ...
    sock = *(int *)arg;
     ...
     {
		//Fica recebendo mensagem do cliente
		buffer[ler_dados] = '\0';
		printf("Cliente %d >> %s\n",sock,buffer);
