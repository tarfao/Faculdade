...
; Abre o arquivo para leitura
    ...
    mov    rbx, arquivo   ; apontador para onde esta o nome do arquivo
    mov    rcx, 0         ; abre o arquivo pra leitura, poderia ser mov ecx, SO_LEITURA
    mov    rdx, 0         ; indiferente neste caso
...
;não foi bem sucedido, então imprime mensagem de erro
    ...
    mov    rbx, 1      ; ou mov ebx, STDOUT    ; escreve msg de erro na tela
    mov    rcx, err      ; define o buffer err para impressao[0]
    mov    rdx, len_err   ;define quantos caracteres a imprimir a partir de buffer[0]
...
leitura:
    ...
    mov    rcx, buf        ; ptr do inicio de buf
    mov    rdx, 256          ; numero de bytes que eu quero
...
; Imprime o conteudo na tela 
    mov    rdx, rax         ; tamanho da mensagem
    mov    rcx, buf         ; endereco inicial da mensagem
    mov    rbx, 1           ; ou mov    ebx, TELA,       ; 
